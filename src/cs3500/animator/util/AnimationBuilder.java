...
/**
 * A builder that allows for the animation model info to be set and then built.
 * @param <Doc> represents the model type doc
 */
public interface AnimationBuilder<Doc> {
   ...
   * @return This {@link AnimationBuilder}
   */
  AnimationBuilder<Doc> addTempo(int start, int end, int speed);
}
